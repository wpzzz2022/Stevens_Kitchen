    ...
    <section class="order-section">
        ...
        <div class="icons-container">
            ...
            <div class="icons">
                ...
                <h3>+86 4008 823 823</h3>
            </div>

            <div class="icons">
                <img src="../assets/images/icon-3.png" alt="">
                <h3>01 Chang An Street, Beijing, China</h3>
            </div>
        ...
        <form id="bookTableForm" @submit="handleSubmit" novalidate autocomplete="off">
            ...
            <div class="row">
                <div class="input-box">
                    ...
                    <textarea placeholder="What do you want us to know?" name="uMessage"
                        id="uMessage" cols="30" rows="10" v-model="orderObj.note"></textarea>
                </div>
                <div class="input-box">
                    <iframe class="map"
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d540.5735052983251!2d116.37067365853788!3d39.96494932449216!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x35f05382dd336635%3A0x47a57ad5cf8c9073!2z5oiQ6YO95bCP5ZCD!5e0!3m2!1szh-CN!2sus!4v1683024807950!5m2!1szh-CN!2sus" 
                        loading="lazy"></iframe>
                </div>
            </div>
            <div class = "row">
    ...
    methods: {
        ...
        checkForm: function () {
            ...
            if (!this.orderObj.phone) {
                ...
                if (!this.orderObj.phone.startsWith('86')) {
                    this.errorObj.phoneErr.push('Phone numbers must start with 86');
                }
