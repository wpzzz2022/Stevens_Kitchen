<template>
    <div class="header">
        <router-link @click="scrollToTop()" to="/" class="logo"><img src="../assets/images/taco-logo.png" alt="" />S-Kitchen
        </router-link>
        ...
        <nav class="navbar">
            ...
            <router-link @click="scrollToTop()" to="/table">reserve</router-link>
