            ...
            <div class="col">
                <div class="row">
                    <div class="menu-tabs">
                        ...
                        <input type="button" id="porkFilterFoodBtn" name="porkFilterFoodBtn" class="menu-tab-item"
                            value="pork" @click="filterFoodBtn($event)" />
                        <input type="button" id="beefFilterFoodBtn" name="beefFilterFoodBtn" class="menu-tab-item"
                            value="beef" @click="filterFoodBtn($event)" />
                        <input type="button" id="chickenFilterFoodBtn" name="chickenFilterFoodBtn" class="menu-tab-item"
